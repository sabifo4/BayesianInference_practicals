...
If you have not yet installed R or RStudio, you can follow 
[this step-by-step tutorial ](https://github.com/sabifo4/RnBash/tree/master/R_installation) for a detailed 
...
values we want to use for $d$ and $\kappa$ (i.e., values that we will 
...
The resulting data frame object `dk` has 10,000 rows and 2 columns, which means that 
